...
config :tokengate, TokengateWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "6h6h2iklBH5n8rtEpz4FOZ/Je8lCwcID+2CERlE5E9qwQFTdTiY+tC5yPlyBQczS",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:tokengate, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:tokengate, ~w(--watch)]}
  ]
...
config :tokengate, TokengateWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/tokengate_web/router\.ex$"E,
      ~r"lib/tokengate_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :tokengate, dev_routes: true
