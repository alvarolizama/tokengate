defmodule Tokengate.Repo.Migrations.CreateModelPricing do
  ...
  def change do
    create table(:model_pricing, primary_key: false) do
      ...
      add :alias_provider_id, references(:alias_providers, type: :binary_id), null: false
    ...
    create index(:model_pricing, [:alias_provider_id])
    create index(:model_pricing, [:alias_provider_id, :effective_from])
  end
end
